...
-- Helper for joining error messages
...
validateAddress street streetNo postcode =
  Address <$> checkStreet street <*> checkNumber streetNo <*> checkPostcode postcode
  where
    checkStreet s =
    ...
    [arg1, op, arg2] ->
      let parseOp = case op of
          ...
          parseArg str
            ...
            | otherwise = invalids ["Invalid number: " ++ str, "Invalid variable: " ++ str]
...
invalids = invalid . joinErrors

-- Ex 14 and 15 use the same `Both` definition as above, and Validation
-- Your test file should now work with all these in place.
